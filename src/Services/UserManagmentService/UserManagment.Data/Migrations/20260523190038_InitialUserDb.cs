        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacebookId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    AppleId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "AppleId",
                unique: true,
                filter: "[AppleId] IS NOT NULL AND [AppleId] != ''");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "FacebookId",
                unique: true,
                filter: "[FacebookId] IS NOT NULL AND [FacebookId] != ''");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "GoogleId",
                unique: true,
                filter: "[GoogleId] IS NOT NULL AND [GoogleId] != ''");
